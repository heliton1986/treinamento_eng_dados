...
# lendo os dados do Data Lake na landing zone
df = spark.read.format("csv")\
    .option("header", "True")\
    .option("inferSchema","True")\
    .csv("s3a://eng-landing/*.csv")
...
# converte(escreve) para formato parquet na processing zone
print ("\nEscrevendo os dados lidos da raw para parquet na processing zone...")
df.write.format("parquet")\
        .mode("overwrite")\
        .save("s3a://eng-processing/df-parquet-file.parquet")

# ler arquivos parquet na processing zone  
df_parquet = spark.read.format("parquet")\
 .load("s3a://eng-processing/df-parquet-file.parquet")
...
# converte(escreve) os dados processados para parquet e escreve na curated zone
df_result.write.format("parquet")\
         .mode("overwrite")\
         .save("s3a://eng-curated/df-result-file.parquet")
